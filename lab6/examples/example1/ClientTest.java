...
public class ClientTest {
	...
	private static final String urls[] = new String[] {
		"http://google.com", "http://www.yahoo.com", "http://www.romania-actualitati.ro/", "http://www.ms.ro/", "http://httpforever.com"
	};
	...
	public static void main(String args[]) {
		...
		long size =100;// convertSize(args[0]);
		long time =100;// convertTime(args[1]);
		...
		int i=100;
		while (i>0) { // incercam cateva citiri aleatoare de adrese folosind cache-ul web
			int poz = r.nextInt(urls.length);
			String page = cache.requestURL(urls[poz]);
			//WebCacheEntry we = (WebCacheEntry)cache.;
			//System.out.println("am ales "+ urls[poz] +" cu accesari"+cache.cache);
